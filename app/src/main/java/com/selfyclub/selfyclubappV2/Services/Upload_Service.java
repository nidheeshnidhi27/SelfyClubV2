package com.selfyclub.selfyclubappV2.Services;
...
import com.selfyclub.selfyclubappV2.ApiClasses.MultiPartRequest;
...
public class Upload_Service extends Service {
    ...
    public int onStartCommand(final Intent intent, int flags, int startId) {
        ...
        if (intent != null && intent.getAction().equals("startservice")) {
            ...
            zipLat = intent.getStringExtra("zipLat");
            zipLng = intent.getStringExtra("zipLng");
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    request.addString("zipLat",zipLat);
                    request.addString("zipLng",zipLng);
                    ...
                    map.put("zipLat",zipLat);
                    map.put("zipLng",zipLng);
