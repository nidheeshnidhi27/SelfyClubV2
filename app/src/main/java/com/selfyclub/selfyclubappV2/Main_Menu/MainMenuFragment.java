...
import com.selfyclub.selfyclubappV2.ActivitesFragment.Notification_F;
...
import com.selfyclub.selfyclubappV2.ActivitesFragment.Discover_F;
import com.selfyclub.selfyclubappV2.ActivitesFragment.Home_F;
import com.selfyclub.selfyclubappV2.Main_Menu.RelateToFragment_OnBack.OnBackPressListener;
...
public class MainMenuFragment extends RootFragment {
    ...
    private void setupTabIcons() {
        ...
        title1.setText(getContext().getResources().getString(R.string.home));
...
//        title2.setText("Discover");
        title2.setText(getContext().getResources().getString(R.string.discover));
...
//        title4.setText("Inbox");
        title4.setText(getContext().getResources().getString(R.string.inbox));
        ...
        title5.setText(getContext().getResources().getString(R.string.profile));
