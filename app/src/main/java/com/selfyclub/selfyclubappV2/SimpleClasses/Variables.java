package com.selfyclub.selfyclubappV2.SimpleClasses;
...
public  class  Variables {
    ...
    public static final String app_hided_folder =root+"/.HidedSelfyClub/";
    public static final String app_showing_folder =root+"/SelfyClub/";
    ...
    public static String latlocation = "latlocation";
    public static String lnglocation = "lnglocation";
