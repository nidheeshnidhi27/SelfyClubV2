...
import com.selfyclub.selfyclubappV2.ActivitesFragment.Accounts.Request_Varification_F;
import com.selfyclub.selfyclubappV2.ApiClasses.ApiLinks;
import com.selfyclub.selfyclubappV2.ChangeLanguage.Change_language_setings;
...
public class Setting_F extends RootFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.change_language_txt).setOnClickListener(this);
    ...
    private void Open_Language() {
        Intent i = new Intent(getContext(), Change_language_setings.class);
        startActivity(i);

        /*Change_language_Fragment change_language = new Change_language_Fragment();
        FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
        transaction.setCustomAnimations(R.anim.in_from_right, R.anim.out_to_left, R.anim.in_from_left, R.anim.out_to_right);
        transaction.addToBackStack(null);
        transaction.replace(R.id.Setting_F, change_language).commit();
*/
