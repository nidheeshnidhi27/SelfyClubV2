...
public class Change_language_setings extends  AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                btConform.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent i = new Intent(Change_language_setings.this, MainMenuActivity.class);
                        startActivity(i);
                    }
                });
...
/*    private void showChangeLanguageDialog() {
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(
                Change_language_setings.this,Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(
                Change_language_setings.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
